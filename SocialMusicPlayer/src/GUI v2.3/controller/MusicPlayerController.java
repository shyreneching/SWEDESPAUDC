...
public class MusicPlayerController {
    ...
    @FXML
    private Button closeBtn, minimizeBtn, playListBtn, followBtn, songsBtn, artistsBtn, albumsBtn, genresBtn, yearsBtn, recentsBtn, mostBtn, artistfollowBtn, listenerfollowBtn, profile_icon_btn, notif_closeBtn, testBtn, listenerunfollowBtn, artistunfollowBtn;
    @FXML
    private Slider slider, volSlider;
    @FXML
    private ProgressBar progress, volProgress;
    @FXML
    private ImageView transitionGif, playBtn, nextBtn, prevBtn, shuffleBtn, repeatBtn, muteBtn, searchBtn, playListMore,createPlaylistBtn;
    @FXML
    private Path pathingStart;
    @FXML
    private AnchorPane transitionPane, song_etc_anchorpane, profile_pane, artist_profile_pane, notif_pane, songsPane,playListKebab;
    @FXML
    ...
    public void initialize() {
        ...
        prof_following_btn.setOnMouseClicked(event -> {
            ...
            for (int i = 0; i <= 24; i++) {
                ...
                followings.setFont(Font.font(36));
        ...
        prof_followers_btn.setOnMouseClicked(event -> {
            ...
            for (int i = 0; i <= 24; i++) {
                ...
                followers.setFont(Font.font(36));
        ...
        artist_prof_playlists_btn.setOnMouseClicked(event -> {
            ...
            for (int i = 0; i <= 24; i++) {
                ...
                playlists.setFont(Font.font(36));
        ...
        artist_prof_following_btn.setOnMouseClicked(event -> {
            ...
            for (int i = 0; i <= 24; i++) {
                ...
                afollowing.setFont(Font.font(36));
        ...
        artist_prof_followers_btn.setOnMouseClicked(event -> {
            ...
            for (int i = 0; i <= 24; i++) {
                ...
                afollowers.setFont(Font.font(36));
